...
export default function BillingPage() {
  ...
  async function checkout(plan: string) {
    ...
    const data = await res.json();
    // Mock checkout: complete immediately via redirect-style URL handling
  ...
  return (
    <div>
      <PageHeader
        ...
        description="Stripe checkout, trials, and plan gating — mocked for this POC."
        actions={
      ...
      <div className="card mb-6 p-5">
        ...
        {subscription?.stripeCustomerId && (
          <div className="mt-2 text-xs text-slate-500">Stripe customer: {subscription.stripeCustomerId}</div>
        )}
      </div>
